...
from csv-b import analyze_b_data # analyze_b_data 함수를 import

def display_analysis_result(df, file_name, analysis_function):
    """분석 결과를 Streamlit에 표시하는 함수 (분석 함수를 인자로 받음)"""
    if df is None:
